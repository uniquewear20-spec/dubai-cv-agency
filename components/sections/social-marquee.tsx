...
const SOCIALS = [
  {
    ...
    href: "https://www.linkedin.com/company/zenithdubaicv",
    icon: (
  ...
  },
  {
    ...
    href: "https://www.instagram.com/zenithdubaicv",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  },
  {
    ...
    href: "https://www.facebook.com/zenithdubaicv",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  },
  {
    ...
    href: "https://twitter.com/zenithdubaicv",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  },
  {
    ...
    href: "https://www.tiktok.com/@zenithdubaicv",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
