...
const ALL_CARDS: Array<{
  ...
  { id:"014", name:"Sebastian Mueller",  cat:"Executive",   type:"Executive / Premium", role:"Managing Director EMEA",         region:"Frankfurt, Germany", img:"/cv2.png", accent:"#60A5FA" },
  { id:"015", name:"Claire Dubois",      cat:"Creative",    type:"Modern / Creative",   role:"Motion Graphics Director",       region:"Paris, France",      img:"/cv3.png", accent:"#C084FC" },
  { id:"016", name:"James Thornton",     cat:"Finance",     type:"Executive / Premium", role:"Private Equity Partner",         region:"London, UK",         img:"/cv4.png", accent:"#F59E0B" },
  { id:"017", name:"Elena Petrova",      cat:"Tech",        type:"Classic / ATS",       role:"Cybersecurity Architect",        region:"Zurich, Switzerland",img:"/cv5.png", accent:"#3B82F6" },
  { id:"018", name:"Marcus Vandenberg",  cat:"Marketing",   type:"Modern / Creative",   role:"Head of Brand Experience",       region:"Amsterdam, NL",      img:"/cv6.png", accent:"#F472B6" },
  { id:"019", name:"Freya Andersen",     cat:"Executive",   type:"Executive / Premium", role:"Board Director, Sustainability", region:"Copenhagen, DK",     img:"/cv7.png", accent:"#60A5FA" },
  { id:"020", name:"Jonas Richter",      cat:"Healthcare",  type:"Classic / ATS",       role:"Hospital Administrator",         region:"Munich, Germany",    img:"/cv8.png", accent:"#34D399" },
  { id:"021", name:"Camille Dupont",     cat:"Hospitality", type:"Modern / Creative",   role:"F&B Operations Director",        region:"Lyon, France",       img:"/cv9.png", accent:"#D4AF37" },
  { id:"022", name:"Nikolai Volkov",     cat:"Oil & Gas",   type:"Executive / Premium", role:"HSE Manager, Offshore",          region:"Oslo, Norway",       img:"/cv10.png", accent:"#FB923C" },
  { id:"023", name:"Sofia Moretti",      cat:"Legal",       type:"Classic / ATS",       role:"Compliance & Regulatory Lead",   region:"Milan, Italy",       img:"/cv11.png", accent:"#A78BFA" },
  { id:"024", name:"Owen Clarke",        cat:"Finance",     type:"Classic / ATS",       role:"Risk & Compliance Manager",      region:"Dublin, Ireland",    img:"/cv12.png", accent:"#F59E0B" },
  { id:"025", name:"Marta Kowalska",     cat:"Tech",        type:"Modern / Creative",   role:"Platform Reliability Engineer",  region:"Warsaw, Poland",     img:"/cv13.png", accent:"#3B82F6" },
  { id:"026", name:"Hugo Schneider",     cat:"Creative",    type:"Classic / ATS",       role:"Brand Identity Designer",        region:"Hamburg, Germany",   img:"/cv14.png", accent:"#C084FC" },
  { id:"027", name:"Luca Romano",        cat:"Aviation",    type:"Classic / ATS",       role:"Cabin Crew Training Manager",    region:"Rome, Italy",        img:"/cv2.png", accent:"#818CF8" },
  { id:"028", name:"Jordan Smith",       cat:"Executive",   type:"Executive / Premium", role:"Chief Financial Officer",        region:"New York, USA",      img:"/cv3.png", accent:"#60A5FA" },
  { id:"029", name:"Elena Rodriguez",    cat:"Marketing",   type:"Modern / Creative",   role:"E-Commerce Growth Manager",      region:"Miami, USA",         img:"/cv4.png", accent:"#F472B6" },
  { id:"030", name:"Daniel Carter",      cat:"Finance",     type:"Classic / ATS",       role:"Business Development Director",  region:"Toronto, Canada",    img:"/cv5.png", accent:"#F59E0B" },
  { id:"031", name:"Valentina Cruz",     cat:"Creative",    type:"Modern / Creative",   role:"UX/UI Design Lead",              region:"Buenos Aires, AR",   img:"/cv6.png", accent:"#C084FC" },
  { id:"032", name:"Mateo Silva",        cat:"Tech",        type:"Classic / ATS",       role:"Full-Stack Engineering Lead",    region:"Sao Paulo, Brazil",  img:"/cv7.png", accent:"#3B82F6" },
  { id:"033", name:"Chloe Bennett",      cat:"Healthcare",  type:"Modern / Creative",   role:"Patient Experience Director",    region:"Vancouver, Canada",  img:"/cv8.png", accent:"#34D399" },
  { id:"034", name:"Rafael Costa",       cat:"Hospitality", type:"Classic / ATS",       role:"Revenue & Yield Manager",        region:"Lisbon, Portugal",   img:"/cv9.png", accent:"#D4AF37" },
  { id:"035", name:"Alejandro Rivera",   cat:"Oil & Gas",   type:"Executive / Premium", role:"Drilling Operations Manager",    region:"Houston, USA",       img:"/cv10.png", accent:"#FB923C" },
  { id:"036", name:"Beatriz Almeida",    cat:"Legal",       type:"Classic / ATS",       role:"Corporate Counsel",              region:"Mexico City, MX",    img:"/cv11.png", accent:"#A78BFA" },
  { id:"037", name:"Noah Laurent",       cat:"Aviation",    type:"Modern / Creative",   role:"Flight Operations Director",     region:"Montreal, Canada",   img:"/cv12.png", accent:"#818CF8" },
  { id:"038", name:"Arjun Mehta",        cat:"Finance",     type:"Modern / Creative",   role:"Fintech Product Director",       region:"Mumbai, India",      img:"/cv13.png", accent:"#F59E0B" },
  { id:"039", name:"Priya Nair",         cat:"Healthcare",  type:"Executive / Premium", role:"Clinical Operations Director",   region:"Singapore",          img:"/cv14.png", accent:"#34D399" },
  { id:"040", name:"Hana Suzuki",        cat:"Hospitality", type:"Executive / Premium", role:"Luxury Hotel GM",                region:"Tokyo, Japan",       img:"/cv2.png", accent:"#D4AF37" },
  { id:"041", name:"Jae-Hyun Kim",       cat:"Executive",   type:"Executive / Premium", role:"VP Corporate Strategy",          region:"Seoul, South Korea", img:"/cv3.png", accent:"#60A5FA" },
  { id:"042", name:"Lin Xia",            cat:"Marketing",   type:"Modern / Creative",   role:"Digital Marketing Director",     region:"Shanghai, China",    img:"/cv4.png", accent:"#F472B6" },
  { id:"043", name:"Min-ji Park",        cat:"Creative",    type:"Modern / Creative",   role:"Content Strategy Director",      region:"Busan, South Korea", img:"/cv5.png", accent:"#C084FC" },
  { id:"044", name:"Linh Tran",          cat:"Legal",       type:"Classic / ATS",       role:"International Trade Lawyer",     region:"Hanoi, Vietnam",     img:"/cv6.png", accent:"#A78BFA" },
  { id:"045", name:"Kenji Tanaka",       cat:"Oil & Gas",   type:"Classic / ATS",       role:"Energy Sector Advisor",          region:"Osaka, Japan",       img:"/cv7.png", accent:"#FB923C" },
  { id:"046", name:"Sander de Vries",    cat:"Aviation",    type:"Classic / ATS",       role:"Air Traffic Control Manager",    region:"Jakarta, Indonesia", img:"/cv8.png", accent:"#818CF8" },
  { id:"047", name:"Michael Nguyen",     cat:"Tech",        type:"Classic / ATS",       role:"DevOps Engineering Lead",        region:"Ho Chi Minh, VN",    img:"/cv9.png", accent:"#3B82F6" },
  { id:"048", name:"Maya Patel",         cat:"Creative",    type:"Modern / Creative",   role:"Brand Identity Director",        region:"Bangalore, India",   img:"/cv10.png", accent:"#C084FC" },
  { id:"049", name:"Zara Mbeki",         cat:"Marketing",   type:"Modern / Creative",   role:"Head of Social Media",           region:"Singapore",          img:"/cv11.png", accent:"#F472B6" },
  { id:"050", name:"Kofi Mensah",        cat:"Executive",   type:"Executive / Premium", role:"Chief Operations Officer",       region:"Accra, Ghana",       img:"/cv12.png", accent:"#60A5FA" },
  { id:"051", name:"Nia Okafor",         cat:"Healthcare",  type:"Modern / Creative",   role:"Global Health Program Manager",  region:"Lagos, Nigeria",     img:"/cv13.png", accent:"#34D399" },
  { id:"052", name:"Aisha Khan",         cat:"Finance",     type:"Classic / ATS",       role:"Treasury & Risk Analyst",        region:"Karachi, Pakistan",  img:"/cv14.png", accent:"#F59E0B" },
  { id:"053", name:"Anya Sokolova",      cat:"Legal",       type:"Executive / Premium", role:"Chief Legal Officer",            region:"Almaty, Kazakhstan", img:"/cv2.png", accent:"#A78BFA" },
  { id:"054", name:"Eva Novak",          cat:"Creative",    type:"Classic / ATS",       role:"Visual Identity Consultant",     region:"Prague, Czechia",    img:"/cv3.png", accent:"#C084FC" },
  { id:"055", name:"Amelia Wright",      cat:"Aviation",    type:"Executive / Premium", role:"Flight Operations Director",     region:"Sydney, Australia",  img:"/cv4.png", accent:"#818CF8" },
];
