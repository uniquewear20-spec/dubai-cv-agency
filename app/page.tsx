...
const WHATSAPP_NUMBER = "971521442139";
const GOLD            = "#D4AF37";
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" placeholder="you@example.com"
                      value={form.senderEmail} disabled={isBusy}
                  ...
                  <div>
                    ...
                    <select value={form.subject} disabled={isBusy}
                  ...
                  <button type="button" onClick={handleSubmit} disabled={!canSubmit}
                    ...
                    {submitState === "sending" ? (
                      <><Loader2 size={15} className="animate-spin" strokeWidth={2.5} />Sending…</>
                    ) : submitState === "error" ? (
                      <><Send size={15} strokeWidth={2.2} />Retry</>
                    ) : (
                  ...
                  <p className="text-center text-[11px]" style={{ color: textSub }}>
                    Sent silently — no email app opens.
                  </p>
                </div>
              )}
            </div>
  ...
  return (
    <div className="min-h-screen w-full font-sans transition-colors duration-300 relative"
      ...
      <main>
        ...
        {/* ── TESTIMONIALS ── */}
        <TestimonialsColumns testimonials={TESTIMONIALS} dark={dark} columns={3} speed={40} />
