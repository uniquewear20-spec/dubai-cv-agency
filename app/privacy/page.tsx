// app/privacy/page.tsx — Zenith Dubai CV · Privacy Policy
"use client";
...
const SECTIONS = [
  {
    ...
    body: `When you submit an enquiry through our contact form, we collect the following information: your email address, the subject and content of your message, and any files you choose to attach, such as a profile photo or existing CV. We collect only what is necessary to respond to your enquiry and deliver our services.\n\nWe do not use cookies for tracking purposes, and we do not collect any information automatically beyond standard server logs that record the date, time, and IP address of requests made to our website.`,
  },
  {
    id: "2",
    title: "How We Use Your Information",
    body: `The information you provide is used exclusively to respond to your enquiry, provide the career document services you have requested, communicate updates about your project, and send your completed documents.\n\nWe do not use your personal information for marketing without your explicit consent, and we do not sell, rent, or share your information with third parties for commercial purposes.`,
  },
  {
    id: "3",
    title: "Data Storage and Security",
    body: `Your information is stored securely and is accessible only to members of the Zenith Dubai CV team involved in delivering your service. We implement appropriate technical and organisational measures to protect your personal data against unauthorised access, alteration, disclosure, or destruction.\n\nSubmitted files and correspondence are retained for the duration of your engagement and for a reasonable period thereafter for record-keeping purposes. You may request deletion of your data at any time by contacting us directly.`,
  },
  {
    id: "4",
    title: "Third-Party Services",
    body: `Our website is hosted on Vercel. We use this service solely for its stated purpose, and it operates under its own privacy policy. We do not grant providers access to your personal information beyond what is technically necessary for service delivery.\n\nWe do not use Google Analytics, Facebook Pixel, or any behavioural tracking tools on this website.`,
  },
  {
    id: "5",
    title: "Your Rights",
    body: `You have the right to access the personal information we hold about you, request correction of inaccurate data, request deletion of your data, withdraw consent for any processing based on consent, and lodge a complaint with a relevant data protection authority.\n\nTo exercise any of these rights, please contact us at info@zenithdubaicv.com. We will respond to all legitimate requests within 30 days.`,
  },
  {
    id: "6",
    title: "International Transfers",
    body: `Zenith Dubai CV is based in Dubai, United Arab Emirates, and serves clients globally. If you are located outside the UAE, your information may be transferred to and processed in the UAE or other countries where our service providers operate. By submitting your information, you acknowledge this transfer.`,
  },
  {
    id: "7",
    title: "Children's Privacy",
    body: `Our services are intended for professional adults and are not directed at individuals under the age of 18. We do not knowingly collect personal information from minors. If you believe a minor has submitted information to us, please contact us and we will delete it promptly.`,
  },
  {
    id: "8",
    title: "Changes to This Policy",
    body: `We may update this Privacy Policy from time to time to reflect changes in our practices or applicable law. The date of the most recent revision is indicated at the top of this page. Continued use of our website or services after any changes constitutes your acceptance of the updated policy.`,
  },
  {
    id: "9",
    title: "Contact",
    body: `If you have any questions about this Privacy Policy or how we handle your personal data, please contact us at info@zenithdubaicv.com or via WhatsApp at +971 50 287 9462. We are committed to addressing your concerns promptly and transparently.`,
  },
];
...
export default function PrivacyPolicy() {
  ...
  useEffect(() => { document.title = "Privacy Policy · Zenith Dubai CV"; }, []);
      ...
      <main className="pt-[76px]">
        <div className="mx-auto max-w-3xl px-8 py-24">
          ...
          <Rise d={0.1}>
            ...
            <h1 className="text-4xl sm:text-5xl font-normal tracking-tight leading-[1.08] mb-4" style={{ color: hi }}>Privacy Policy</h1>
          ...
          <Rise d={0.2} className="mb-16">
            <p className="text-base leading-[1.9]" style={{ color: sub, fontFamily: "sans-serif", fontWeight: 300 }}>
              Zenith Dubai CV is committed to protecting your personal information. This Privacy Policy explains what data we collect, how we use it, and your rights in relation to it. By using our website or services, you agree to the practices described in this policy.
            </p>
          </Rise>
          ...
          <Rise d={0.1} className="mt-16">
            ...
            <p className="text-sm leading-[1.9] mb-8" style={{ color: sub, fontFamily: "sans-serif", fontWeight: 300 }}>Questions about this policy? We are happy to help.</p>
        ...
        <footer className="py-8 px-8 border-t" style={{ borderColor: bdr }}>
          <div className="mx-auto max-w-3xl flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-5">
              <a href="/privacy" className="text-[10px]" style={{ color: G, fontFamily: "sans-serif", textDecoration: "none", opacity: 0.7 }}>Privacy Policy</a>
              <span style={{ color: bdr, fontSize: "10px" }}>·</span>
              <a href="/terms" className="text-[10px] transition-opacity hover:opacity-70" style={{ color: dark ? "rgba(200,169,110,0.35)" : `${hi}45`, fontFamily: "sans-serif", textDecoration: "none" }}>Terms of Service</a>
            </div>
          </div>
        </footer>
      </main>
